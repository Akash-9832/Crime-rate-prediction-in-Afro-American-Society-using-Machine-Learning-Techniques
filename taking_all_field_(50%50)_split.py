...
print("93.ViolentCrimesPerPop-LemasSwornFT: ",b93)
...
x115 = df['LemasPctPolicOnPatr']
x0115 = x115.to_list()
# print(x0115)
sum0115=0
for i in range(n):
    sum0115=sum0115+x0115[i]
avg0115=sum0115/n
print("115.LemasPctPolicOnPatr Average: ",avg0115)
l115=[]    
for i in range(n):
   
   a0115=x0115[i]-avg0115
   b0115=y00[i]-y000
   c0115=a0115*a0115
   d0115=a0115*b0115
   a115=d0115/c0115
...
print("115.ViolentCrimesPerPop-LemasPctPolicOnPatr: ",b115)



x116 = df['LemasPctOfficDrugUn']
x0116 = x116.to_list()
# print(x0116)
sum0116=0
for i in range(n):
    sum0116=sum0116+x0116[i]
avg0116=sum0116/n
print("116.LemasPctOfficDrugUn Average: ",avg0116)
l116=[]    
for i in range(n):
   
   a0116=x0116[i]-avg0116
   b0116=y00[i]-y000
   c0116=a0116*a0116
   d0116=a0116*b0116
   a116=d0116/c0116
...
print("116.ViolentCrimesPerPop-LemasPctOfficDrugUn: ",b116)
...
x117 = df['PolicBudgPerPop']
x0117 = x117.to_list()
# print(x0117)
sum0117=0
for i in range(n):
    sum0117=sum0117+x0117[i]
avg0117=sum0117/n
print("117.PolicBudgPerPop Average: ",avg0117)
l117=[]
for i in range(n):
   
   a0117=x0117[i]-avg0117
   b0117=y00[i]-y000
   c0117=a0117*a0117
   d0117=a0117*b0117
   a117=d0117/c0117
...
print("117.ViolentCrimesPerPop-PolicBudgPerPop: ",b117)
...
b07=(b91*avg091+b92*avg092+b93*avg093+b94*avg094+b95*avg095+b96*avg096+b97*avg097+b98*avg098+b99*avg099+b100*avg0100+b101*avg0101+b102*avg0102+b103*avg0103+b104*avg0104+b105*avg0105)
b08=(b106*avg0106+b107*avg0107+b108*avg0108+b109*avg0109+b110*avg0110+b111*avg0111+b112*avg0112+b113*avg0113+b114*avg0114+b115*avg0115+b116*avg0116+b117*avg0117)

b0=y000-(b01+b02+b03+b04+b05+b06+b07+b08)
...
for i in range(n,1994):
    ...
    y07=b91*x091[i]+b92*x092[i]+b93*x093[i]+b94*x094[i]+b95*x095[i]+b96*x096[i]+b97*x097[i]+b98*x098[i]+b99*x099[i]+b100*x0100[i]+b101*x0101[i]+b102*x0102[i]+b103*x0103[i]+b104*x0104[i]+b105*x0105[i]
    y08=b106*x0106[i]+b107*x0107[i]+b108*x0108[i]+b109*x0109[i]+b110*x0110[i]+b111*x0111[i]+b112*x0112[i]+b113*x0113[i]+b114*x0114[i]+b115*x0115[i]+b116*x0116[i]+b117*x0117[i]

    y=b0+y01+y02+y03+y04+y05+y06+y07+y08
